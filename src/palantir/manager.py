...
from palantir.program import DrillStep, MoveStep, Rig, StandbyStep, StartStep
...
class Manager:
    ...
    def _run_program(self):
        ...
        drilling = self._config['drilling']

        for rig_name, details in drilling.items():

            rig = Rig(name=rig_name)
            self.rigs.append(rig)

            program_steps = details['program']
